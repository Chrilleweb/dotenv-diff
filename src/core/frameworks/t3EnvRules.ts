...
export function applyT3EnvRules(
  ...
  if (isClientContext && allServerVars.includes(u.variable) && !allClientVars.includes(u.variable)) {
    warnings.push({
      variable: u.variable,
  ...
  if (isServerContext && allClientVars.includes(u.variable) && !allServerVars.includes(u.variable)) {
    warnings.push({
      variable: u.variable,
  ...
  if (!allServerVars.includes(u.variable) && !allClientVars.includes(u.variable)) {
    warnings.push({
      variable: u.variable,
